    ...
    */
    public function collection(Collection $collection)
    {
        ...
        $community = Community::create([
            ...
            'picture' => 'data:image/jpeg;base64, '.base64_encode(file_get_contents(Storage::get('img_community.jpg')))
        ]);
        ...
        if ($community != null) {
            ...
            $piece = Piece::create([
                ...
                'picture' => 'data:image/jpeg;base64, '.base64_encode(file_get_contents(Storage::get('piece.jpeg'))),
                'is_piece' => 1,
                'is_material' => 0,
            ...
            $material = Piece::create([
                'uuid' => Str::uuid(),
                'name' => 'PLA',
                'description' => 'data:image/jpeg;base64, '.base64_encode(file_get_contents(Storage::get('material.jpeg'))),
                'picture' => '',
                'is_material' => 1,
                'is_piece' => 0,
                'community_id' => $community->id
